...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'body',
                    models.TextField(
                        max_length=100000, verbose_name='Function Body'
                    ),
                ),
                (
                    'version',
                    models.IntegerField(
                        default=0, verbose_name='Function Version'
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'object_id',
                    models.CharField(
                        max_length=50, verbose_name='Related Object'
                    ),
                ),
                (
                    'status',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'field_name',
                    models.CharField(
                        max_length=200, verbose_name='Field Name'
                    ),
                ),
                (
                    'content_type',
        ...
        migrations.AlterUniqueTogether(
            name='workflow', unique_together={('content_type', 'field_name')}
        ),
        migrations.AlterUniqueTogether(
            name='transitionmeta',
            unique_together={
